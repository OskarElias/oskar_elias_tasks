		...
		<header style="background: #9E3E33;">
			<div class="container-fluid">
				<div class="row justify-content-between">
					<!-- col for img/banner -->
					<div class="col-md-4">
						<a href="ex2.php" class="d-flex align-items-center text-black text-decoration-none">
					...
					<div class="col-md-4">
                        ...
                        <div class="row position-relative d-flex align-items-end flex-column mb-4 nav-div">
                            <nav class="mb-auto p-2">
                                <ul class="nav">
                                    <li class="nav-item"><a href="ex2-merch.php" class="nav-link text-black">Merchandise</a></li>
                                    <li class="nav-item"><a href="ex2-lineup.php" class="nav-link text-black">Line-up</a></li>
                                    <li class="nav-item"><a href="ex2-tickets.php" class="nav-link text-black">Tickets</a></li>
                                    <li class="nav-item"><a href="ex2-schedule.php" class="nav-link text-black">Schedule</a></li>
                                    <li class="nav-item"><a href="ex2-about.php" class="nav-link text-black">About</a></li>
                                </ul>
                            </nav>
                        </div>
					</div>
